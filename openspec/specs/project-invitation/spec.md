...
Define outbound project invitations so a creator can invite specific users to collaborate on a project after creation.
...
- GIVEN a project owner is viewing a project collaborator page
