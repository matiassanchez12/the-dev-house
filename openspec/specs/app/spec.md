...
- GIVEN an open dropdown menu with focus on the first item WHEN the user presses Arrow Down THEN focus SHALL move to the next menu item AND focus SHALL wrap to the first item when reaching the end WHEN the user presses Arrow Up THEN focus SHALL move to the previous item AND focus SHALL wrap to the last item when reaching the beginning
