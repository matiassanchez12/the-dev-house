        ...
        return (
            <Pagination>
                <PaginationContent>
                    <PaginationItem>
                        <PaginationPrevious
                            onClick={() => handlePageChange(milestones.links.find((link) => link.label.includes('&laquo;'))?.url ?? null)}
                        />
                    </PaginationItem>
                        ...
                        page === 'ellipsis' ? (
                            ...
                            <PaginationItem key={page}>
                                <PaginationLink
                                    ...
                                    onClick={() => {
                                        const link = milestones.links.find((item) => item.label === String(page));
                    ...
                    <PaginationItem>
                        <PaginationNext
                            onClick={() => handlePageChange(milestones.links.find((link) => link.label.includes('&raquo;'))?.url ?? null)}
                        />
                    </PaginationItem>
                </PaginationContent>
            </Pagination>
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <Card className="mb-8">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Últimos avances cerrados por los proyectos de la comunidad
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <div className="mb-6 flex items-center justify-between">
                            <p className="text-sm text-muted-foreground">
                                {milestones.meta.total === 1
                                    ? '1 logro encontrado'
                                    : `${milestones.meta.total} logros encontrados`}
                            </p>
                        </div>
                        ...
                        {milestones.data.length === 0 ? (
                            <Empty className="py-16">
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>
                                        Cuando los proyectos empiecen a cerrar hitos, van a aparecer acá.
                                    </EmptyDescription>
                                </EmptyHeader>
                                <EmptyContent>
