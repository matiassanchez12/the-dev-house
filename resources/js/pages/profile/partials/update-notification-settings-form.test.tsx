...
describe('UpdateNotificationSettingsForm', () => {
    ...
    it('associates the collaboration emails control with its inline error text', () => {
        mockState.errors = {
            collaboration_emails: 'No se pudo guardar la preferencia de emails',
        }
        ...
        expect(
            screen.getByRole('checkbox', { name: /Recibir emails opcionales de colaboración/i }),
        ).toHaveAttribute('aria-describedby', 'notification-collaboration-emails-error')
        expect(screen.getByRole('alert')).toHaveTextContent(
            'No se pudo guardar la preferencia de emails',
        )
    })
})
