            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="lg:col-span-1 flex flex-col items-center lg:items-start">
                        <Link href="/" className="flex items-center gap-3 mb-4">
                            <ApplicationLogo variant="icon" className="h-10 w-10" />
                            <div>
                                <span className="font-display font-bold text-lg text-foreground">The Dev House</span>
                            </div>
                        </Link>
                        <p className="text-sm text-muted-foreground text-center lg:text-left mb-6">
                            Donde los desarrolladores construyen juntos. Colabora, aprende y crea proyectos increíbles en comunidad.
                        </p>
                        {/* Social links */}
                ...
                <div className="border-t border-border/50 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-sm text-muted-foreground">
                        &copy; {new Date().getFullYear()} The Dev House. Todos los derechos reservados.
                    </p>
                    <p className="text-sm text-muted-foreground">
                        Hecho con{" "}
