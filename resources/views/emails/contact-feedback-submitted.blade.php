...
>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 18px 0;border-collapse:separate;border-spacing:0 12px;">
        <tr>
            <td style="padding:14px 16px;border:1px solid #262626;border-radius:12px;background-color:#171717;">
                <div style="font-size:11px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:#f59e0b;line-height:1.2;">
                    ¿Entendió para qué sirve?
                </div>
                <div style="margin-top:6px;font-size:14px;line-height:1.6;color:#d4d4d4;">
